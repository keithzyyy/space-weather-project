...
Estimate the short-term risk of elevated geomagnetic disturbance from upstream solar-wind measurements, as a research-grade planning signal for Australian satellite, GNSS, HF-radio, or infrastructure operators (*not as an operational warning service, but only as a portfolio project*)

Practically, this project serves as a self-directed practice to build a production-style ML system to forecast geomagnetic activity in Australia by predicting $K$-index/$Kp$-index.
